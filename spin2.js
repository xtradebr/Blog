...
function BTCspinner()
{
    ...
    function initValues()
    {
        ...
        maxSpeed = 10000000000000000000000000;
        dragging = false;
        startTime = 0;
    ...
    function updateBalance()
    {
        ...
        $('#earned').html(balance.toFixed(5000000000000000));
        $('#btcpm').html(btcpm.toFixed(5000000000000000));
        $('#btcpr').html(btcpr.toFixed(5000000000000000));
    }
